...
const personalities = {
  A: {
    ...
    description: "Сен Абай Құнанбайұлына ұқсайсың — ойшыл, сабырлы, рухани терең тұлғасың. Абай сияқты сен адам мінезін, қоғамдағы әділеттілікті, білім мен еңбектің құндылығын жоғары қоясың.",
    mainValue: "Сен үшін ішкі тыныштық пен адамгершілік басты орында.",
    strengths: "Сабыр, даналық, талғам.",
    modernRole: "Мотивация беретін ойшыл, медиа мен білім саласында бағыт көрсетуші болар едің.",
  },
  B: {
    key: "BAUYRZHAN",
    ...
    description: "Сен Бауыржан Момышұлына ұқсайсың — ержүрек, жауапкершілігі жоғары және әділеттілікті сүйетін тұлғасың. Бауыржан сияқты сен батыл шешім қабылдап, еліңді, жақындарыңды қорғауға дайынсың.",
    mainValue: "Қиындық саған сын емес, шыңдалу мүмкіндігі.",
    strengths: "Тәртіп, төзімділік, намыс.",
    modernRole: "Қоғамды алға жетелейтін әскери, спорттық немесе көшбасшылық бағыттағы тұлға болар едің.",
  },
  C: {
    key: "TOMIRIS",
    ...
    description: "Сен Томирис патшайымға ұқсайсың — әділет пен тәуелсіздікті бәрінен жоғары қоясың. Томирис секілді сен әділдік үшін соңына дейін күресуге дайынсың, әлсізді қорғайсың.",
    mainValue: "Сен үшін еркіндік пен теңдік — өмір мәні.",
    strengths: "Батылдық, шешімділік, рух күші.",
    modernRole: "Қоғамдағы теңдік, әйел құқығы мен ұлттық рухты қорғаушы тұлға болар едің.",
  },
  D: {
    key: "AKHMET",
    ...
    description: "Сен Ахмет Байтұрсынұлына ұқсайсың — ағартушылық пен білім сенің жолың. Ахмет сияқты сен айналаңдағы адамдарды үйретіп, білім арқылы қоғамды оятқың келеді.",
    mainValue: "Сен үшін сөздің күші мен ұлттың тілі — қасиетті.",
    strengths: "Ұстаздық, зияткерлік, тіл сезімі.",
    modernRole: "Педагог, журналист немесе мәдениет қайраткері ретінде ұлттың санасын жаңғыртар едің.",
  },
  E: {
    key: "ALIKHAN",
    ...
    description: "Сен Әлихан Бөкейханұлына ұқсайсың — халықтың қамын ойлайтын көшбасшысың. Әлихан секілді сен әділдікке, демократияға, халықтың бірлігіне сенесің.",
    mainValue: "Сен стратегиялық ойлайсың және командамен жұмыс істеуге бейімсің.",
    strengths: "Көшбасшылық, талдау, жауапкершілік.",
    modernRole: "Саясаткер, қоғам белсендісі немесе ірі жобалардың жетекшісі болар едің.",
  },
};
